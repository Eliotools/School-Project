...
void my_printf(char *str, ...)
{
    va_list list;
    int j = 0;
    void (*point_fonc[])() = {&percent_id, &percent_id, &percent_s, &percent_c,
    &percent_b, &percent_S, &percent_, &percent_u, &percent_o, &percent_X,
    &percent_x, &percent_p};
    char a[13] = {'d', 'i', 's', 'c', 'b', 'S', '%',
    'u', 'o', 'X', 'x', 'p', 0};
